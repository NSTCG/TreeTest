import {Component, Type, Mesh, MeshAttribute, MeshIndexType, property, Material, MeshComponent} from '@wonderlandengine/api';
...
export class HeightMap extends Component {
    ...
    @property.float(128.0)
    resolutionX: number;

    @property.float(256.0)
    resolutionY: number;
    ...
    start() {
        ...
        this.canvas.setAttribute('width', this.resolutionX.toString());
        this.canvas.setAttribute('height', this.resolutionY.toString());
